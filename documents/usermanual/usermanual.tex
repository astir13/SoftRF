...
\title{\Huge User Manual\\[5mm]\Large SoftRF (Github astir13/SoftRF fork)\\[5mm]matching SoftRF firmware version 1.3f}
\date{2022-03-25\\[10mm]Thanks to all contributrs of the Github SoftRF Project.\\[3cm]\includegraphics[scale=.4]{softrf.jpg}}
\begin{document}
% some defines
...
\chead{User Manual v.\/1.3f rev.\/0}
...
\begin{versionhistory}
  ...
  \vhEntry{1.3f rev. 0}{2022-03-25}{astir13}{autopower off at 50\% battery level, not after 10 minutes}
\end{versionhistory}
